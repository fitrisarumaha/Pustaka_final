...
class Buku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('judul_buku', 'judul buku', 'required|min_lenght[3]', [
            ...
            'requires' => 'Judul buku terlalu pendek' 
        ]);
        $this->form_validation->set_rules('id_kategori', 'kategori', 'required',[
            'required' => 'Nama pengarang harus diisi', 
        ]);
        $this->form_validation->set_rules('pengarang', 'Nama pengarang', 'required|min_lenght[3]', [
            'required' => 'Nama pengarang harus diisi',
            'min_lenght' => 'Nama pengarang terlalu pendek' 
        ]);
        $this->form_validation->set_rules('penerbit', 'Nama penerbit', 'required|min_lenght[3]', [
            'required' => 'Nama penerbit harus diisi',
            'min_lenght' => 'Nama penerbit terlalu pendek'
        ]);
        $this->form_validation->set_rules('tahun', 'Tahun Terbit', 'required|min_lenght[3]|max_lenght[4]numeric', [
            'required' => 'Tahun terbit harus diisi',
            'min_lenght' => 'Tahun terbit terlalu pendek',
            'max_lenght' => 'Tahun terbit terlalu panjang',
